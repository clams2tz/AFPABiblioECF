 ...
 */
final class Version20241211201701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservations ADD user_id INT NOT NULL, ADD date_created DATE NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservations DROP user_id, DROP date_created');
    }
}
